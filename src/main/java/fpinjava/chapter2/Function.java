...
//    The operation compose() on functions takes 2 arguments and it applies second and then applies first.
...
//    The operation andThen() on functions takes 2 arguments and it applies first and then applies second.
